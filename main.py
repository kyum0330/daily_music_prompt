...
4. 노래 가사에서는 각 항목의 구간 시간, 악기 및 분위기 구성을 적어주세요. 이때 가사 외의 데이터는 영어로 <> 속에 넣어서 표현해주세요.
5. 세부 항목이 적힌 노래 가사가 끝난 하단에는 단을 따로 구분하여, 세부 항목 없는 노래 가사만을 파트별 단 구분하여 적어주세요.
6. 마지막으로 이 노래의 전체적인 곡 내용과 분위기에 알맞게 유튜브 노출을 위한 해쉬태그를 나열해서 정리 부탁해요.
